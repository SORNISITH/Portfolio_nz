...
<template>
  <div class="w-full">
    <div class="w-full flex flex-col justify-center items-center shadow-sm p-5">
      <h1 class="text-4xl">Mini - Library Vue 3</h1>
    </div>
    ...
    <div class="w-full flex justify-center items-center">
      <div class="gap-20 sm:gap-4 lg:gap-10 w-[90%] px-[5%] grid grid-cols-5">
        <div
          ...
          :key="index"
          class="aspect-[3/4.5] hover:border-4 hover:border-black bg-gray-200 flex flex-col hover:scale-[1.1] cursor-pointer transition-transform duration-200 shadow-md"
        >
          <a :href="book.href" target="_blank" class="w-full h-full flex flex-col">
            <div
              class="border-blue-900 hover:border-black border-l-20 bg-gray-400 w-full h-[80%] transition-border duration-200 justify-center items-center flex"
            >
              <img :src="book.img" alt="" class="object-cover h-full w-full" />
            </div>
            <div class="h-[20%] overflow-hidden flex justify-center items-center w-full">
              <p class="text-center md:text-xl text-blue-800">
                {{ book.shortTitle }}
              </p>
            </div>
          </a>
